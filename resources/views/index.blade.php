...
<section class="section pb-0">
            ...
            @foreach ($editorsPick as $post)
                <article class="card">
                    <div class="post-slider slider-sm">   ` 
                      <img src="{{ config('app.url') }}/public/client/images/{{$post->urlHinh }}" class="card-img-top" alt="post-thumb">
                    </div>
                    <div class="card-body">
                        <a class="post-title" href="{{ route('chitiet.show', ['id' => $post->idTin]) }}">{{ $post->TieuDe }}</a>
                        <ul class="card-meta list-inline">
                            <li class="list-inline-item">
                                <a href="#" class="card-meta-author">
                                    <img src="{{ config('app.url') }}/public/client/images/{{$post->urlHinh }}">
            ...
            @foreach ($trendingPosts as $post)
                <article class="card mb-4">
                    <div class="card-body d-flex">
                        <img class="card-img-sm" src="{{ config('app.url') }}/public/client/images/{{$post->urlHinh }}">
                        <div class="ml-3">
                            <h4><a href="{{ route('chitiet.show', ['id' => $post->idTin]) }}" class="post-title">{{ $post->TieuDe }}</a></h4>
        ...
        <div class="col-lg-4 mb-5">
            ...
            @foreach ($popularPosts as $post)
                <article class="card">
                    ...
                    <div class="card-body">
                        <h3 class="h4 mb-3"><a class="post-title" href="{{ route('chitiet.show', ['id' => $post->idTin]) }}">{{ $post->TieuDe }}</a></h3>
                        <ul class="card-meta list-inline">
                            <li class="list-inline-item">
                                <a href="#" class="card-meta-author">
                                    <img src="{{ config('app.url') }}/public/client/images/{{$post->urlHinh }}" alt="Kate Stone">
 ...
 <!-- Trong file view của bạn, ví dụ: index.blade.php -->
          ...
          <div class="col-lg-8  mb-5 mb-lg-0">
              ...
              @foreach($posts as $post)
                  <article class="card mb-4">
                      ...
                      <div class="card-body">
                          <h3 class="mb-3"><a class="post-title" href="{{ route('chitiet.show', ['id' => $post->idTin]) }}">{{ $post->TieuDe }}</a></h3>
                          <ul class="card-meta list-inline">
                              <li class="list-inline-item">
                          ...
                          <p>{{ $post->TomTat }}</p>
                          <a href="post-details/{{ $post->slug }}" class="btn btn-outline-primary">Read More</a>
                      </div>
                  </article>
              @endforeach
          ...
          <aside class="col-lg-4 sidebar-home">
              ...
              <div class="widget widget-categories">
                  ...
                  <ul class="list-unstyled widget-list">
                      ...
                      <li><a href="tags.html" class="d-flex">New York City <small class="ml-auto">(1)</small></a></li>
                      ...
                      <li><a href="tags.html" class="d-flex">Wonderland <small class="ml-auto">(1)</small></a></li>
                  </ul>
              </div>
                  ...
                  @foreach($posts as $post)
                      <article class="widget-card">
                          <div class="d-flex">
                              <img class="card-img-sm" src="{{ config('app.url') }}/public/client/images/{{$post->urlHinh }}">
                              <div class="ml-3">
                                  <h5><a class="post-title" href="post-details/{{ $post->slug }}">{{ $post->TieuDe }}</a></h5>
                                  <ul class="card-meta list-inline mb-0">
                                      <li class="list-inline-item mb-0">
                                        {{ \Carbon\Carbon::parse($post->Ngay)->format('Y/m/d') }}
